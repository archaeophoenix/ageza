...
<html>
<head>
  <title>Satuan Kerja Perangkat Daerah (SKPD) Kabupaten Lamongan</title>
...
<div class="app-container apps-login" style="background-color: #39c3da;">
    ...
    <div class="app-body">
      ...
      <div class="app-form">
        <div class="form-header">
          <div class="app-brand"><img style="max-height: 200px; max-width: 200px; height: auto; width: auto;" class="media-object" src="<?php echo base_url().'/assets/images' ?>/kablamongan.png" alt="Satuan Kerja Perangkat Daerah (SKPD) Kabupaten Lamongan"></div>
        </div>
        <form class="form" method="post" action="<?php echo base_url(); ?>login">
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-info btn-submit" title="Login">Login</button>
            </div>
        </form>
