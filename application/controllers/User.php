...
class User extends CI_Controller {
    ...
    private function data($id = null){
        ...
        $condition = (empty($id)) ? null : 'WHERE id = '.$id ;

        return $this->Dml_model->{$method}('user' , $condition,'id, nama, status, telpon, username');
    }
    ...
    function field($id = null){
        ...
        $data['status'] = ['Inactive','Admin','Auditor','K-SKPD','Evaluator','Inspektur/Sekretaris'];
